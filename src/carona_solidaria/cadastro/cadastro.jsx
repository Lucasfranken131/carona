    ...
    return (
        <div className="container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="number" name="age" value={formData.age} onChange={handleInputChange} placeholder="Idade" required />
                ...
                <input type="number" name="phone_number" value={formData.phone_number} onChange={handleInputChange} placeholder="Número de Telefone" required minLength="8" maxLength="8" />
